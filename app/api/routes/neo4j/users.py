"""
User management routes for Neo4j with JWT authentication.

This module provides endpoints for user CRUD operations with authentication.
Users can only access and modify their own data.
"""
from fastapi import APIRouter, HTTPException, Depends, status
from backend.services.neo4j.user_service import UserService
...
async def update_user(
    ...
    """
    Update a user's information in Neo4j.
...
async def update_username(
    ...
    """
    Update only the user's username in Neo4j.
