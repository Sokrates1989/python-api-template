"""Wellness routes owned by the demo backend app."""
from __future__ import annotations

from fastapi import APIRouter, Depends, HTTPException, Query, status

from api.shared_dependencies.auth import get_user_id_from_token
from apps.demo_app.schemas.wellness import (
...
from apps.demo_app.services.wellness_service import DemoAppWellnessService

router = APIRouter(tags=["wellness"], prefix="/v1/wellness")


def get_service() -> DemoAppWellnessService:
    """Return the demo app wellness service."""
    return DemoAppWellnessService()
