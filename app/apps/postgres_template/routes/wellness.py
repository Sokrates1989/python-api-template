"""Wellness routes owned by the Postgres Template backend app."""
from __future__ import annotations

from fastapi import APIRouter, Depends, HTTPException, Query, status

from api.shared_dependencies.auth import get_user_id_from_token
from apps.postgres_template.schemas.wellness import (
...
from apps.postgres_template.services.wellness_service import PostgresTemplateWellnessService

router = APIRouter(tags=["wellness"], prefix="/v1/wellness")


def get_service() -> PostgresTemplateWellnessService:
    """Return the Postgres Template wellness service."""
    return PostgresTemplateWellnessService()
