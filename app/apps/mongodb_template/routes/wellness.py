"""Wellness routes owned by the MongoDB Template backend app."""
from __future__ import annotations

from fastapi import APIRouter, Depends, HTTPException, Query, status

from api.shared_dependencies.auth import get_user_id_from_token
from apps.mongodb_template.schemas.wellness import (
...
from apps.mongodb_template.services.wellness_service import MongoDBTemplateWellnessService

router = APIRouter(tags=["wellness"], prefix="/v1/wellness")


def get_service() -> MongoDBTemplateWellnessService:
    """Return the MongoDB Template wellness service."""
    return MongoDBTemplateWellnessService()
