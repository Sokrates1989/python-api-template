...
class Neo4jWellnessRepositoryAdapter:
    """Adapt the Neo4j wellness service to the repository protocol."""

    def __init__(self) -> None:
        from backend.services.neo4j.wellness_service import WellnessService as Neo4jWellnessService

        self._service = Neo4jWellnessService()
